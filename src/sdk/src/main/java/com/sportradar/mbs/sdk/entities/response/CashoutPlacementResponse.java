...
public class CashoutPlacementResponse extends ContentResponse {
    ...
    public static class Builder {
        ...
        private final CashoutPlacementResponse instance = new CashoutPlacementResponse();

        private Builder() {
        }

        public CashoutPlacementResponse build() {
